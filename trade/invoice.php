...
?>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
	  ...
	  <tr>
		...
		<th width="150" <?php if($last == "totalLiveTrades") echo("class=\"sort\""); ?>><a href="javascript:void(0);" onclick="sorter('totalLiveTrades');">Total Live Trades</a> <?php addSortArrow("totalLiveTrades",$last); ?></th>
		<th width="150" <?php if($last == "totalCommission") echo("class=\"sort\""); ?>><a href="javascript:void(0);" onclick="sorter('totalCommission');">Total Commission</a> <?php addSortArrow("totalCommission",$last); ?></th>
		<th width="150">Last Invoice Date</th>
	  </tr>
	  </thead>
	  <tbody>

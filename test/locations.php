...
<script language="javascript" type="text/javascript" src="scripts/ajax.js"></script>
	...
	if($_POST["locationName"] != "")
		$query.= " WHERE fldLocationName LIKE \"%".ereg_replace(" ","%",$_POST["locationName"])."%\"";
	...
	<div class="controlBar">
		<div class="floatLeft">
			<!--<input type="button" name="addNew" value="Add New Client" onclick="launchLocation();" class="buttonBlue"/>-->
		</div>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
	  <tr>
        ...
        <th width="200" <?php if($last == "locationName") echo("class=\"sort\""); ?>><a href="javascript:void(0);" onclick="sorter('locationName');">Location Name</a> <?php addSortArrow("traderName",$last); ?></th>
		<th width="130" <?php if($last == "region") echo("class=\"sort\""); ?>><a href="javascript:void(0);" onclick="sorter('region');">Geo. Region</a> <?php addSortArrow("region",$last); ?></th>

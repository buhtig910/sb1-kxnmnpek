...
if(isset($param)){
	...
	$query = "SELECT t.*,b.fldProductGroup FROM $tblTransaction t, $tblTradeType b, $tblProduct p WHERE t.fkProductGroup=b.pkTypeID AND t.fkProductID=p.pkProductID AND pkTransactionID=".$tradeID;
	//echo("<p>".$query."</p>");

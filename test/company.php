...
<script language="javascript" type="text/javascript" src="scripts/ajax.js"></script>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
	  <tr>
		...
		<th width="250" <?php if($last == "companyName") echo("class=\"sort\""); ?>><a href="javascript:void(0);" onclick="sorter('traderName');">Company Name</a> <?php addSortArrow("companyName",$last); ?></th>
		<th>Invoice Email</th>
        <th>Address</th>
        <th width="75">Traders</th>
	  </tr>
		...
		if($count >=1){
			...
			while($resultSet = mysqli_fetch_row($result)){
				...
				*/
				...
				echo("<td align=\"center\"><a href=\"javascript:void(0);\" onclick=\"confirmCompanyDelete($resultSet[0]);\">Delete</a> &nbsp; <a href=\"javascript:void(0);\" onclick=\"launchCompany($resultSet[0]);\">Edit</a></td>\n");
